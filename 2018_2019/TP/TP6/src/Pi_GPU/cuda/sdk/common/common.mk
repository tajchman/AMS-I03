#WBL 20 March 2009 pickup system inputs but send output to own dirs
#
################################################################################
#
...
SRCDIR     ?= 
#ROOTDIR    ?= ..
ROOTDIR    ?= /home/staff/langdon/cuda/sdk/
ROOTBINDIR ?= $(ROOTDIR)/../bin
BINDIR     ?= $(ROOTBINDIR)/$(OSLOWER)
ROOTOBJDIR ?= obj
ROOTDIR2   ?= /opt/cuda/sdk/tools
LIBDIR     ?= $(ROOTDIR2)/../lib
COMMONDIR  := $(ROOTDIR2)/../common
