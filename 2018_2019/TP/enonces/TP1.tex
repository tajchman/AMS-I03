...
\section{Optimisation de la localité spatiale et temporelle}

\subsection{Produit matrice-vecteur}

On utilise ici un code qui calcule (une approximation de) la plus grande valeur propre d'une matrice, dans le fichier source {\tt src/valeur\_propre/power1.cpp}.
