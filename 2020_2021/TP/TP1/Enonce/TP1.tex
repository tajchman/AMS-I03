...
\begin{itemize}
	\item 	Pour compiler, se placer dans le répertoire {\tt TP1/Poisson\_OpenMP\_fine\_grain} et taper:
...
\begin{frame}[fragile]
	On fournit aussi un script pour comparer les speedup pour différents nombres de threads:
