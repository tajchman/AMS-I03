...
\begin{frame}
	Le contrôle et le maintien de la cohérence de cache est une des raisons de la diminution d'efficacité du parallélisme multithreads
	
	\vfill
	Pour diminuer le coût de ce contrôle, il faut si possible 
	\vfill
