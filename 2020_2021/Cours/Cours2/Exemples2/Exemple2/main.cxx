...
int main(int argc, char **argv) {
  ...
  std::cout << "\nCalcul parallele (threads = " << nThreads << ", offset = 1)  : " << std::endl;
  double v1 = somme1(v, nThreads);
  //std::cout << "  difference = " << (v1 - v0)/v0 << std::endl;

  std::cout << "\nCalcul parallele (threads = " << nThreads << ", offset = " << offset << ")  : " << std::endl;
  double v2 = somme2(v, nThreads, offset);
  //std::cout << "  difference = " << (v2 - v0)/v0 << std::endl;
 
  std::cout << "\nCalcul parallele (threads = " << nThreads << ")  : " << std::endl;
  double v3 = somme3(v, nThreads);
  //std::cout << "  difference = " << (v3 - v0)/v0 << std::endl;
