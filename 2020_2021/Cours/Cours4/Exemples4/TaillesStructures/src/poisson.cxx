...
*/
  if ( my_rank == 0 ) 
  {
    timestamp ( );
    fprintf (stderr,  "\n" );
    fprintf (stderr,  "POISSON_MPI:\n" );
    fprintf (stderr,  "  C version\n" );
    fprintf (stderr,  "  2-D Poisson equation using Jacobi algorithm\n" );
    fprintf (stderr,  "  ===========================================\n" );
    fprintf (stderr,  "  MPI version: 1-D domains, non-blocking send/receive\n" );
    fprintf (stderr,  "  Number of processes         = %d\n", num_procs );
    fprintf (stderr,  "  Number of interior vertices = %d\n", N );
    fprintf (stderr,  "  Desired fractional accuracy = %f\n", epsilon );
    fprintf (stderr,  "\n" );
  }
...
*/
    ...
    {
      fprintf (stderr,  "  N = %d, n = %d, my_n = %d, Step %4d  Error = %g\n", 
...
*/
  ...
  {
    fprintf (stderr,  "\n" );
    fprintf (stderr,  "  Wall clock time = %f secs\n", wall_time );
  }
  memory_used("avant MPI_Finalize");
/*
  Terminate MPI.
*/
  MPI_Finalize ( );
  memory_used("apres MPI_Finalize");
/*
  Free memory.
*/
  free ( f );
