...
\vfill
Il y a donc \verb|nT| régions parallèles (avec création des threads à l'entrée - ligne 15 - et destruction des threads à la sortie - ligne 18).
\vfill
\end{frame}
...
\framebox{
\begin{minipage}{10cm}
Devoir à rendre avant la prochaine séance :
\bigskip

\begin{quote}
	Examiner les sources dans chaque sous-répertoire (\ {\tt main.cxx, calcul.cxx}\ ).
	
	Faire tourner plusieurs fois chaque version, commenter les résultats.
\end{quote}
\end{minipage}
}
\end{frame}
