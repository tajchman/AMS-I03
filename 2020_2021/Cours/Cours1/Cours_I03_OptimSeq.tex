...
Pour obtenir le maximum de performances, il faudrait programmer en connaissant exactement l'organisation des mémoires cache. C'est (très) compliqué de faire un code qui est performant sur plusieurs machines différentes. 
\vfill
