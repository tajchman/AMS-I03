...
p.open('enchainementHybride2.tex')
...
ypos = 0.35*p3[1] + 0.65*p4[1]
p.add(Line((r4[0] - 0.55, ypos), (p4[0] + 1.05, ypos), arrow='->', linewidth=0.2, linecolor='green'))
p.add(Text((p4[0] * 0.85 + r4[0] * 0.15, ypos + 1.1), "Message 1"))
p.add(Text((p4[0] * 0.85 + r4[0] * 0.15, ypos + 0.2), "$T_0(P_1) \\rightarrow T_2(P_0)$"))

ypos = 0.35*p4[1] + 0.65*p6[1]
p.add(Line((p4[0] + 0.05, ypos), (r4[0] - 0.05, ypos), arrow='->', linewidth=0.2, linecolor='green'))
p.add(Text((p4[0] * 0.8 + r4[0] * 0.2, ypos + 1.1), "Message 2"))
p.add(Text((p4[0] * 0.8 + r4[0] * 0.2, ypos + 0.2), "$T_0(P_0) \\rightarrow T_0(P_1)$"))

ypos = ypos - 1.4
p.add(Line((r4[0] - 0.55, ypos), (p4[0] + 0.05, ypos), arrow='->', linewidth=0.2, linecolor='green'))
p.add(Text((p4[0] * 0.85 + r4[0] * 0.15, ypos - 1.1), "Message 3"))
p.add(Text((p4[0] * 0.85 + r4[0] * 0.15, ypos - 2.2), "$T_1(P_1) \\rightarrow T_0(P_0)$"))
