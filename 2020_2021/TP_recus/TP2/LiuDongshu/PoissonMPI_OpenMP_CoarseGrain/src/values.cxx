...
void Values::init()
{
  ...
  int imin_thread = m_p.imin_thread(0, iT);
  int jmin_thread = m_p.imin_thread(1, iT);
  int kmin_thread = m_p.imin_thread(2, iT);

  int imax_thread = m_p.imax_thread(0, iT);
  int jmax_thread = m_p.imax_thread(1, iT);
  int kmax_thread = m_p.imax_thread(2, iT);
