...
Parameters::Parameters(int argc, char ** argv)
{
  ...
  m_help = a.options_contains("h") || a.options_contains("help");
...
bool Parameters::help()
{
  if (m_help) {
    ...
    std::cerr << "Options:\n\n"
              ...
              << "n1=<int>       : number of internal points in the X direction (default: 400)\n"
              << "n2=<int>       : number of internal points in the Y direction (default: 400)\n"
              << "n3=<int>       : number of internal points in the Z direction (default: 400)\n"
