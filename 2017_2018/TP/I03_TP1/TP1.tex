...
\textcolor{red}{\bf
Utiliser cette classe pour mesurer s\'eparement le temps d'initialisation et une moyenne du temps de calcul d'une it\'eration de calcul dans le code fourni.}
\end{frame}
\end{document}