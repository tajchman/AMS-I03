...
\newcommand\question[1]{\bigskip\par\addtocounter{cptQuestions}{1}{\bf Question #1 n\textsuperscript{o} \thecptQuestions}\par}

\newcounter{cptProblems}
\newcommand\problem{\bigskip\rule{3cm}{.1pt}\par\addtocounter{cptProblems}{1}{\bf Probl\` eme n\textsuperscript{o} \thecptProblems}\par}
...
Ajouter une parall\'elisation MPI pour obtenir une parall\'elisation hybride.
	...
	$$
	o\`u $\kappa(u)$ est une fonction non-lin\'eaire de $u$ et on suppose que le temps n\'ecessaire pour calculer $\kappa(u)$ est proportionnel \`a $\vert u\vert$.
    
    \medskip
    Le sch\'ema num\'erique utilis\'e ici, calcule une approximation $u_i^{n}$ de $u(i \Delta x, n \Delta t)$.
	...
	\question{}
     ...
     Ajouter un pragma OpenMP avant la boucle sur {\tt v[k]} pour parall\'eliser cette boucle sur plusieurs threads.
     
	\question{}
     
     Qu'est ce qui peut provoquer du d\'es\'equilibre de charge entre les diff\'erents threads dans la boucle ci-dessus ?
