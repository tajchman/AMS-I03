...
\textcolor{red}{Vue globale}: un ensemble de n\oe uds de calcul chacun contenant un ou plusieurs processeurs et de la m\'emoire, les n\oe uds sont connect\'es par un r\'eseau:
...
\begin{center}
\includegraphics[scale=0.25]{../Images/architecture2}
\end{center}

Memory : m\'emoire de travail pour vos donn\'ees.

L1-L2-L3 : mémoires à accès plus rapide mais plus petites 

La gestion des m\'emoires (copie, contr\^ole de coh\'erence, etc.) est faite par un contr\^oleur m\'emoire
\end{frame}
...
\end{lstlisting} & 
\frame{\includegraphics[scale=0.5]{../Images/ex1a.pdf}}
\end{tabular}
