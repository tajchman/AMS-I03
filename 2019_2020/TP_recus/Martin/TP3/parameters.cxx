    ...
    for (int i=0; i<3; i++) {
     ...
     int j; 
      if (i == 0) {
        ...
        //ici on peut pas paralleliser parce que le code est sequentiel, c'est à dire,
        //on a besoin des valeurs anterieurs modifiés
        //Si on coupe le boucle, le premier valeur de chaque boucle local utilisera 
        //des valeurs non modifiés, et ça donnera des résultats incorrectes
        ...
        m_thread_imax[0][m_nthreads-1] = m_imax[0];
      	...
      	#pragma parallel for private(j,i)
