...
<<<<<<< HEAD:2019_2020/TP/TP4/TP4_corrige/PoissonMPI_OpenMP_FineGrain/src/values.cxx
    int j, k;
...
void Values::init(double (*f)(double, double, double))
{
  ...
  int jmax = m_p->imax(1);
  int kmax = m_p->imax(2);
>>>>>>> 62781e041545eccbf74ed4f8f55460f39ca0625a:2019_2020/TP_corriges/TP4_corrige/PoissonMPI_OpenMP_FineGrain/src/values.cxx
