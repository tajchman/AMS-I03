...
%    \layout
    ...
    Récupérer l'archive compressée {\tt TP3.tar.gz} sur le site web 
...
On parle d'OpenMP grain grossier, quand on crée les threads (par un pragma omp parallel) et c'est le programmeur qui répartit le travail entre les threads:
