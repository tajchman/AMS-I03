...
{
  size_t   di = m_di[0],     dj = m_di[1],     dk = m_di[2];
  size_t i, j, k;
  double du, du_sum;

  size_t imin = m_P->imin(0) ;
  size_t jmin = m_P->imin(1) ;
  size_t kmin = m_P->imin(2) ;

  size_t imax = m_P->imax(0) ;
  size_t jmax = m_P->imax(1) ;
  size_t kmax = m_P->imax(2) ;
